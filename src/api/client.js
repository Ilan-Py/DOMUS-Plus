...
api.interceptors.response.use(
  ...
  async (error) => {
    ...
    // 401 = sin token o token inválido/expirado (config/auth.js), 403 reservado
    // para autorización (autenticado pero sin permiso) — hoy no lo emite
    // ningún endpoint, pero se sigue chequeando por si acaso.
